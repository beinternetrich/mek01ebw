...
$rowsets= array(
    ...
    array("yfile02", "N2wp.zip", "/install/", "/"),
	array("yfile03", "N3sh.zip", "/install/", "/eShop/"),
	array("yfile04", "N4sh.zip", "/install/", "/eShop/"),
	array("yfile05", "N5sh.zip", "/install/", "/eShop/"),
	array("yfile06", "N6sh.zip", "/install/", "/")
); 
...
$maspaz    = 'Ll3QrYm!y0U*2M$'; //'Ll3QqYN!y0U*2$m'  //'P!55w0D4ec4LdB';  //cHh4ng3m3EMLn0w!
$dbpazz    =  $maspaz;
$cppazzok  =  false;
$msg       = '';
$msgfinal  = '';
...
<br/></td>
<td>
<br/><span>&nbsp;<input style="font-size: medium; font-weight:600;" name="iwebtit" size="30" value="<?php echo htmlentities($webtitle); ?>" /></span><br/><center></center></td>
</tr>
